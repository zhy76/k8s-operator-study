...
import (
	...
	ingressv1beta1 "github.com/zhy76/k8s-operator-study/api/v1beta1"
)
...
//+kubebuilder:rbac:groups=ingress.zhy76.com,resources=apps,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=ingress.zhy76.com,resources=apps/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=ingress.zhy76.com,resources=apps/finalizers,verbs=update
