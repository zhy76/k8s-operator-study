...
**Note:** go-get or vendor this package as `k8s-operator-study/controller-study/crd-controller-demo`.
...
```sh
go get -d k8s-operator-study/controller-study/crd-controller-demo
cd $GOPATH/src/k8s-operator-study/controller-study/crd-controller-demo
godep restore
```
...
`kubernetes/staging/src/k8s-operator-study/controller-study/crd-controller-demo` and its dependencies
...
```sh
kubectl delete crd apps.appcontroller.zhy.com
```
...
https://github.com/kubernetes/kubernetes/blob/master/staging/src/k8s-operator-study/controller-study/crd-controller-demo.
